...
## Methods
***Note:*** *Due to large file size, CSV may not have correctly uploaded to GitHub.  Original CSV file can be downloaded* [here](https://s3.amazonaws.com/tripdata/201908-citibike-tripdata.csv.zip).
